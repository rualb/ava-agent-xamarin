CREATE TABLE [L_FIRMPARAMS] (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE,
...
CREATE TABLE L_CAPIWHOUSE (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE,
	NR NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
...
GO
 ...
 CREATE TABLE LG_$FIRM$_CLCARD (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE,
	CODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	DEFINITION_ NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	SPECODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CYPHCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CLGRPCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CLGRPCODESUB NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	...
	ORDDAY NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	SPE_ORDDAY NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	DISCPER FLOAT NULL DEFAULT 0,
	BARCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	FILTERPROMOCL NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	...
	UNIONCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
...
CREATE TABLE LG_$FIRM$_ITEMS (
	...
	STGRPCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	STGRPCODESUB NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNIT1 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNIT2 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNIT3 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNITREF1 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNITREF2 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNITREF3 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	...
	BARCODE1 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	BARCODE2 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	BARCODE3 NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
...
CREATE TABLE LG_$FIRM$_$PERIOD$_INVOICE (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE ,
	FICHENO NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	...
	SPECODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CYPHCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CLIENTREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	SOURCEINDEX NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	DESTINDEX NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
...
CREATE TABLE LG_$FIRM$_$PERIOD$_STLINE (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE ,
	STOCKREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	...
	DESTINDEX NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	IOCODE SMALLINT NULL DEFAULT 0,
	STDOCREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	...
	UNITREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	UNIT NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	...
	CANCELLED SMALLINT NULL DEFAULT 0,
	PRCLIST SMALLINT NULL DEFAULT 0,
	ORFLINEREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	SCRIPTFLG SMALLINT NULL DEFAULT 0,
	SCRIPTEXP NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	RECVERS SMALLINT NULL DEFAULT 0,
	CREATEDDATE DATETIME NULL DEFAULT '1900-01-01',
...
CREATE TABLE LG_$FIRM$_$PERIOD$_KSLINES (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE ,
	FICHENO NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	CLIENTREF NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	CARDREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	DATE_ DATETIME NULL DEFAULT '1900-01-01',
	TRCODE SMALLINT NULL DEFAULT 0,
	SPECODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CYPHCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
...
CREATE TABLE LG_$FIRM$_$PERIOD$_INFOPERIOD (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	CODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	VALUE_ NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
...
CREATE TABLE LG_$FIRM$_$PERIOD$_INFODOCSAVE (
	LOGICALREF NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	CODE NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	TYPE NVARCHAR(50) NOT NULL COLLATE NOCASE DEFAULT '',
	STOCKREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	PROMOREF NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
	CF1 FLOAT NULL DEFAULT 0,
	CF2 FLOAT NULL DEFAULT 0,
	CLCODE NVARCHAR(50) NULL COLLATE NOCASE DEFAULT '',
...
CREATE TABLE LG_GENSEQ (
	ID INT NULL,
	LASTLREF INT NOT NULL
	)
GO

INSERT INTO LG_GENSEQ
VALUES (
	1,
	0
	)
