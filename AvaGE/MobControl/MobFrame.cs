...
{
    public class MobFrame : FrameLayout, IControlGlobalInit, ISelfDestructable
    {


        public MobFrame(Context context)
            : base(context)
        {


        }
        public MobFrame(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
