...
{
    public class MobDataReferenceSlipsSales: MobImplDataReferenceForGridForm
    {
 
        public MobDataReferenceSlipsSales(string pCmd)
        ...
        {
            return typeof(MobDataReferenceSalesForm);
        }
    }
}
