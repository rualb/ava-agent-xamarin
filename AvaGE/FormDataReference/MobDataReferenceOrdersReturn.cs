...
{
    public class MobDataReferenceOrdersReturn: MobImplDataReferenceForGridForm
    {
        public MobDataReferenceOrdersReturn(string pCmd)
        ...
        {
            return typeof(MobDataReferenceOrdersReturnForm);
        }
