...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceSlipsExcessForm : MobDataReferenceForMoveForm
    {
        protected override string globalStoreName()
        {
            return ConstRefCode.slipsExcess;// "ref.mm.excess";
        }
        public MobDataReferenceSlipsExcessForm()
            : base(0)
        {
        ...
        protected override void setSource(IPagedSource pSource)
        {
            ...
            pSource.getBuilder().addPereparer(new SqlBuilderPreparerFixedCondition(TableINVOICE.TRCODE, ConstDocTypeMaterial.materialExcess));
        ...
        {
            return ConstAdapterNames.adp_mm_doc_excess;
        }
