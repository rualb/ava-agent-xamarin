...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceReturnsForm : MobDataReferenceForMoveForm
    {


        protected override string globalStoreName()
        {
            return ConstRefCode.docSaleReturn;// "ref.sls.wholesale.return";
        }
        public MobDataReferenceReturnsForm()
            : base(0)
        {
        ...
        {
            return ConstAdapterNames.adp_sls_doc_wholesaleret;
        }
