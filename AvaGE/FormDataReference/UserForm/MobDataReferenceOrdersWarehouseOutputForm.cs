...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceOrdersWarehouseOutputForm : MobDataReferenceForOrderForm
    {

        protected override string globalStoreName()
        {
            return ConstRefCode.orderWarehouseOut;// "ref.mm.warehouse.order.output";
        }
        public MobDataReferenceOrdersWarehouseOutputForm()
            : base(0)
        {
        ...
        protected override void setSource(IPagedSource pSource)
        {
            ...
            pSource.getBuilder().addPereparer(new SqlBuilderPreparerFixedCondition(TableINVOICE.TRCODE, ConstDocTypeMaterial.marerialDefinedOutput20)); 
 
        }
        
        protected override string getAdapterCode()
        {
            return ConstAdapterNames.adp_mm_doc_order_warehouse_output;
        }
