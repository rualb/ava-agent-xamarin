...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceOrdersSaleForm : MobDataReferenceForOrderForm
    {

        protected override string globalStoreName()
        {
            
            return ConstRefCode.docOrderSale;// "ref.sale.wholesale.order";
        }
        ...
        {
            return ConstAdapterNames.adp_sls_doc_order_wholesale;
        }
