...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceSlipsWarehouseOutputForm : MobDataReferenceForMoveForm
    {
        protected override string globalStoreName()
        {
            return ConstRefCode.slipWarehouseOut;// "ref.mm.warehouse.slip.output";
        }
        public MobDataReferenceSlipsWarehouseOutputForm()
            : base(0)
        {
        ...
        {
            return ConstAdapterNames.adp_mm_doc_slip_warehouse_output;
        } 
