...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceSlipsDeficitForm : MobDataReferenceForMoveForm
    {
        protected override string globalStoreName()
        {
            return ConstRefCode.slipsDeficit;// "ref.mm.deficit";
        }
        public MobDataReferenceSlipsDeficitForm()
            : base(0)
        {
        ...
        protected override void setSource(IPagedSource pSource)
        {
            ...
            pSource.getBuilder().addPereparer(new SqlBuilderPreparerFixedCondition(TableINVOICE.TRCODE, ConstDocTypeMaterial.materialDeficit));
        ...
        {
            return ConstAdapterNames.adp_mm_doc_deficit;
        }
