...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceOrdersPurchaseForm : MobDataReferenceForOrderForm
    {

        protected override string globalStoreName()
        {
            
            return ConstRefCode.docOrderPurchase;// "ref.sale.wholesale.order";
        }

        public MobDataReferenceOrdersPurchaseForm()
            : base(0)
        {
        ...
        {
            return ConstAdapterNames.adp_prch_doc_order_purchase;
        }
