...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceOrdersWarehouseListForm : MobDataReferenceForOrderForm
    {

        protected override string globalStoreName()
        {
            return ConstRefCode.orderWarehouseList;// "ref.mm.warehouse.order.input";
        }
        public MobDataReferenceOrdersWarehouseListForm()
            : base(0)
        {
        ...
        protected override void setSource(IPagedSource pSource)
        {
            ...
            pSource.getBuilder().addPereparer(new SqlBuilderPreparerFixedCondition(TableINVOICE.TRCODE, ConstDocTypeMaterial.marerialDefinedInput18));
   
        }
        
        protected override string getAdapterCode()
        {
            return ConstAdapterNames.adp_mm_doc_order_warehouse_list;
        }
