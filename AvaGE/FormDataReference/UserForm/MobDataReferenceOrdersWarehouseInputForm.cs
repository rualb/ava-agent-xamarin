...
namespace AvaGE.FormDataReference.UserForm
{
    ...
    public class MobDataReferenceOrdersWarehouseInputForm : MobDataReferenceForOrderForm
    {

        protected override string globalStoreName()
        {
            return ConstRefCode.orderWarehouseIn;// "ref.mm.warehouse.order.input";
        }
        public MobDataReferenceOrdersWarehouseInputForm()
            : base(0)
        {
        ...
        {
            return ConstAdapterNames.adp_mm_doc_order_warehouse_input;
        }
