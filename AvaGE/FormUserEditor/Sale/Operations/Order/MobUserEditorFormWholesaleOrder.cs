...
namespace AvaGE.FormUserEditor.Sale.Operations.Order
{
    ...
    public partial class MobUserEditorFormWholesaleOrder : MobUserEditorFormMaterialDocOrder
    {
        protected override string globalStoreName()
        {
            return ConstAdapterNames.adp_sls_doc_order_wholesale;// "form.sale.doc.wholesale.order";
        }
        public MobUserEditorFormWholesaleOrder() 
            :base(  null,     0)
        {
