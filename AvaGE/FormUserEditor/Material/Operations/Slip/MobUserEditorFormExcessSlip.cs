...
namespace AvaGE.FormUserEditor.Material.Operations.Slip
{
    ...
    public partial class MobUserEditorFormExcessSlip : MobUserEditorFormMaterialDoc
    {
        protected override string globalStoreName()
        {
            return ConstAdapterNames.adp_mm_doc_excess;// "form.mm.doc.excess";
        }
        public MobUserEditorFormExcessSlip() 
            :base(  null,     0)
        {
