...
namespace AvaGE.FormUserEditor.Material.Operations.Slip
{
    ...
    public partial class MobUserEditorFormWarehouseSlipInput : MobUserEditorFormMaterialDoc
    {
        protected override string globalStoreName()
        {
            return ConstAdapterNames.adp_mm_doc_slip_warehouse_input;// "form.mm.doc.warehouse.slip.output";
        }


        public MobUserEditorFormWarehouseSlipInput()
            : base(null, 0)
        {
