...
namespace AvaGE.FormUserEditor.Material.Operations.Order
{
    ...
    public partial class MobUserEditorFormWarehouseOrderCounting : MobUserEditorFormMaterialDocOrder
    {
        protected override string globalStoreName()
        {
            return ConstAdapterNames.adp_mm_doc_order_warehouse_counting;// "form.mm.doc.warehouse.order.input";
        }


        public MobUserEditorFormWarehouseOrderCounting() 
            :base(  null,     0)
        {
