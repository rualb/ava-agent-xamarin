...
namespace AvaGE.FormUserEditor.Material.Operations.Order
{
    ...
    public partial class MobUserEditorFormWarehouseOrderOutput : MobUserEditorFormMaterialDocOrder
    {
        protected override string globalStoreName()
        {
            return ConstAdapterNames.adp_mm_doc_order_warehouse_output;// "form.mm.doc.warehouse.order.output";
        }
        public MobUserEditorFormWarehouseOrderOutput() 
            :base(  null,     0)
        {
