...
namespace AvaGE.FormUserEditor.Material.Operations.Order
{
    ...
    public partial class MobUserEditorFormWarehouseOrderList : MobUserEditorFormMaterialDocOrder
    {
        protected override string globalStoreName()
        {
            return ConstAdapterNames.adp_mm_doc_order_warehouse_list;// "form.mm.doc.warehouse.order.input";
        }


        public MobUserEditorFormWarehouseOrderList()
            : base(null, 0)
        {
        ...
        protected override int amountMode()
        {
            return 1;
        }
