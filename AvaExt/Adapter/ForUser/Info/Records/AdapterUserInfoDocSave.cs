...
{
    public class AdapterUserInfoDocSave : AdapterUserRecords
    {



        public AdapterUserInfoDocSave(IEnvironment pEnv, IAdapterDataSet pDsAdapter)
            : base(pEnv, pDsAdapter, TableINFODOCSAVE.TABLE)
        {
        ...
        protected override void prepareBeforeUpdate(DataSet pDataSet)
        {
            ...
            DataTable tab;
            DataRow row;
            tab = pDataSet.Tables[TableINFODOCSAVE.TABLE];
