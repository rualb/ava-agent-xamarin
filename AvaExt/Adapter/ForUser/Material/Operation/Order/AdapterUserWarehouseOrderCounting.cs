...
{
    public class AdapterUserWarehouseOrderCounting : AdapterUserWarehouseSlip
    {
        public AdapterUserWarehouseOrderCounting(IEnvironment pEnv, IAdapterDataSet pAdapterDataSet)
            : base(pEnv, pAdapterDataSet)
        {
            lineIOCode = docIOCode = (short)ConstIOCode.inputFromWarehouse;
            lineTrCode = docTrCode = (short)ConstDocTypeMaterial.marerialDefinedInput19;
        }
