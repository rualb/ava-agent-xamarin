...
{
    public class AdapterUserWarehouseOrderInput : AdapterUserWarehouseSlip
    {
        public AdapterUserWarehouseOrderInput(IEnvironment pEnv, IAdapterDataSet pAdapterDataSet)
