...
{
    public class AdapterUserWarehouse : AdapterUserRecords
    {



        public AdapterUserWarehouse(IEnvironment pEnv, IAdapterDataSet pDsAdapter)
            : base(pEnv, pDsAdapter, TableWHOUSE.TABLE)
        {
        ...
        protected override void prepareBeforeUpdate(DataSet pDataSet)
        {
            ...
            DataTable tab;
            DataRow row;
            tab = pDataSet.Tables[TableWHOUSE.TABLE];
